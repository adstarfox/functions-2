...
// CODE HERE
uniq(names, (uniqArr) => console.log(`The new names array with all the duplicate items revomved is ${uniqArr}`))
...
// CODE HERE
each(names,(indexParam, itemParam) => console.log(`The item at index ${indexParam} is ${itemParam}`)) 
...
const add22 = addingFactory(22)
console.log(add22(17))
